...
<form:form modelAttribute="product" method="post" action="/products/edit/${id}" enctype="multipart/form-data">
    ...
    <input type="text" name="oldImageUrl" value="${image}" style="display: none">
    ...
    <div><form:button type="submit">Cập  nhật</form:button>
        <a href="<%=request.getContextPath()%>/products">Quay lại</a></div>
</form:form>
</body>
</html>
